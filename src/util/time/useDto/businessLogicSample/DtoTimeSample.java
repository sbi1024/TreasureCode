...
import util.time.useDto.library.ReqDto;
import util.time.useDto.library.RetDto;
import util.time.useDto.library.TimeHelper;

public class DtoTimeSample {
    public static void testCase() {
        ...
        RetDto retDto20 = TimeHelper.createTimeLibrary().callingMethod(reqDto20);
        // retDto 값 확인진행
        ...
        RetDto retDto30 = TimeHelper.createTimeLibrary().callingMethod(reqDto30);
        // retDto 값 확인진행
        ...
        RetDto retDto40 = TimeHelper.createTimeLibrary().callingMethod(reqDto40);
        // retDto 값 확인진행
        ...
        RetDto retDto50 = TimeHelper.createTimeLibrary().callingMethod(reqDto50);
        // retDto 값 확인진행
        ...
        // callingMethod 를 통한 repeatType 40 인 경우의 결과 반환값을 확인
        RetDto retDto60 = TimeHelper.createTimeLibrary().callingMethod(reqDto60);
        // retDto 값 확인진행
        ...
        // callingMethod 를 통한 repeatType 40 인 경우의 결과 반환값을 확인
        RetDto retDto70 = TimeHelper.createTimeLibrary().callingMethod(reqDto70);
        // retDto 값 확인진행
        ...
        // callingMethod 를 통한 repeatType 30 인 경우의 결과 반환값을 확인
        RetDto retDto71 = TimeHelper.createTimeLibrary().callingMethod(reqDto71);
        // retDto 값 확인진행
        ...
        RetDto retDto72 = TimeHelper.createTimeLibrary().callingMethod(reqDto72);
        // retDto 값 확인진행
        ...
        RetDto retDto80 = TimeHelper.createTimeLibrary().callingMethod(reqDto80);
        // retDto 값 확인진행
